...
#coding=utf-8
# =================================================
# =   Mã nguồn thuộc về thongld@VN Open Playlist  =
# =================================================
...
plugin         = Plugin()
addon          = xbmcaddon.Addon("plugin.video.hitplaylist")
pluginrootpath = "plugin://plugin.video.hitplaylist"
...
def GetSheetIDFromSettings():
	sid = "1l6TcaMsEINocqUPyLF0mhSBUW5y36tDwVDXpXImx4eY"
	...
	for row in _json["table"]["rows"]:
		...
		if "plugin://" in item["path"]:
			...
			if "spreadsheets/d/" in item["path"]:
				# https://docs.google.com/spreadsheets/d/1l6TcaMsEINocqUPyLF0mhSBUW5y36tDwVDXpXImx4eY/edit#gid=0
