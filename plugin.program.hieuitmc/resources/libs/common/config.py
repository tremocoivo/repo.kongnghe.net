...
class Config:
    ...
    def init_uservars(self):
        ...
        self.ICONCE = uservar.ICONCE if not uservar.ICONCE.endswith('://') else self.ADDON_ICON
    ...
    def init_settings(self):
        ...
        # self.BACKUPLOCATION = xbmc.translatePath(self.get_setting('path')
    ...
    def open_settings(self, id=None, cat=None, set=None, activate=False):
        ...
        try:
            ...
            self.set_setting('path', backupdir)
    ...
    def clear_setting(self, type):
        build = {'buildname': '', 'buildversion': '', 'buildtheme': '',
                 'latestversion': '', 'nextbuildcheck': '2019-01-01 00:00:00', 'buildlink': ''}
