...
class MainMenu:
    ...
    def get_listing(self):
        ...
        directory.add_dir('[COLOR red][B]INSTALL KODI:[/B][/COLOR] Cài Đặt Kodi Full Addon', {'mode': 'builds'}, icon=CONFIG.ICONBUILDS, themeit=CONFIG.THEME1)
        ...
        directory.add_dir('[B][COLOR green]BACKUP[/COLOR]/[COLOR yellow]RESTORE[/COLOR]:[/B] Sao Lưu/Khôi Phục Bản Kodi Cá Nhân', {'mode': 'maint', 'name': 'backuprestore'}, icon=CONFIG.ICONMAKECUSTOM, themeit=CONFIG.THEME1)
        ...
        directory.add_separator()
        directory.add_file('[B][COLOR yellow]Like[/COLOR] and [COLOR pink]Donate[/COLOR][/B]: Ủng Hộ Tác Giả', {'mode': 'settings', 'name': CONFIG.ADDON_ID}, icon=CONFIG.ICONSETTINGS, themeit=CONFIG.THEME1)
