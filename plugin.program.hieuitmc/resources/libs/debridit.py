...
ORDER = ['myaccountsrd', 'myaccountspm', 'myaccountsad', 'shadowrd', 'shadowad', 'shadowpm', 'serenrd', 'serenpm',  'serenad', 'kaitord', 'kaitopm',  'kaitoad', 'rurlrd', 'rurlpm', 'rurlad', 'urlrd', 'urlpm', 'urlad', 'foxyrd', 'foxypm', 'foxyad', 'pmzer']   
...
DEBRIDID = {
    'myaccountsrd': {
        'name': '[B]***My Accounts REAL DEBRID For FEN And Venom***[/B]',
    ...
    'myaccountspm': {
        'name': '[B]***My Accounts PREMIUMIZE For FEN And Venom***[/B]',
        'plugin': 'script.module.myaccounts',
        'saved': 'myaccountspm',
        'path': os.path.join(CONFIG.ADDONS, 'script.module.myaccounts'),
        'icon': os.path.join(CONFIG.ADDONS, 'script.module.myaccounts', 'icon.png'),
    ...
    'myaccountsad': {
        'name': '[B]***My Accounts ALLDEBRID For FEN And Venom***[/B]',
        'plugin': 'script.module.myaccounts',
        'saved': 'myaccountsad',
        'path': os.path.join(CONFIG.ADDONS, 'script.module.myaccounts'),
        'icon': os.path.join(CONFIG.ADDONS, 'script.module.myaccounts', 'icon.png'),
    ...
    'kaitoad':  {
        'name'     : '[B]***Kaito Anime ALL Debrid***[/B]',
    ...
    'kaitord': {
        'name'     : '[B]***Kaito Anime Real Debrid***[/B]',
        'plugin'   : 'plugin.video.kaito',
        'saved'    : 'kaitord',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.kaito'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.kaito', 'icon.png'),
    ...
    'kaitopm': {
        'name'     : '[B]***Kaito Anime Premiumize***[/B]',
        'plugin'   : 'plugin.video.kaito',
        'saved'    : 'kaitopm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.kaito'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.kaito', 'icon.png'),
    ...
    'rurlrd': {
        'name'     : '[B]***ResolveURL Real Debrid***[/B]',
    ...
    'rurlad': {
        'name': '[B]***ResolveURL ALL Debrid***[/B]',
        'plugin': 'script.module.resolveurl',
        'saved': 'rurlad',
        'path': os.path.join(CONFIG.ADDONS, 'script.module.resolveurl'),
        'icon': os.path.join(CONFIG.ADDONS, 'script.module.resolveurl', 'icon.png'),
    ...
    'rurlpm': {
        'name'     : '[B]***ResolveURL Premiumize***[/B]',
        'plugin'   : 'script.module.resolveurl',
        'saved'    : 'rurlpm',
        'path'     : os.path.join(CONFIG.ADDONS, 'script.module.resolveurl'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'script.module.resolveurl', 'icon.png'),
    ...
    'urlrd': {
        'name'     : '[B]***URLResolver Real Debrid***[/B]',
    ...
    'urlad': {
        'name': '[B]***URLResolver ALL Debrid***[/B]',
        'plugin': 'script.module.urlresolver',
        'saved': 'urlad',
        'path': os.path.join(CONFIG.ADDONS, 'script.module.urlresolver'),
        'icon': os.path.join(CONFIG.ADDONS, 'script.module.urlresolver', 'icon.png'),
    ...
    'urlpm': {
        'name'     : '[B]***URLResolver Premiumize***[/B]',
        'plugin'   : 'script.module.urlresolver',
        'saved'    : 'urlpm',
        'path'     : os.path.join(CONFIG.ADDONS, 'script.module.urlresolver'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'script.module.urlresolver', 'icon.png'),
    ...
    'foxyrd': {
        'name'     : '[B]***FoxyStreams Real Debrid***[/B]',
    ...
    'foxyad': {
        'name': '[B]***FoxyStreams ALL Debrid***[/B]',
        'plugin': 'plugin.video.foxystreams',
        'saved': 'foxyad',
        'path': os.path.join(CONFIG.ADDONS, 'plugin.video.foxystreams'),
        'icon': os.path.join(CONFIG.ADDONS, 'plugin.video.foxystreams', 'icon.png'),
        ...
        'activate': 'RunPlugin'},		
    'foxypm': {
        'name'     : '[B]***FoxyStreams Premiumize***[/B]',
        'plugin'   : 'plugin.video.foxystreams',
        'saved'    : 'foxypm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.foxystreams'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.foxystreams', 'icon.png'),
    ...
    'pmzer': {
        'name'     : '[B]***Premiumizer Debrid Cloud***[/B]',
        ...
        'default'  : 'premiumize.token',
        'data'     : ['premiumize.authorization', 'premiumize.token'],
